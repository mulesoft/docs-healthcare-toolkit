...
This document assumes a working knowledge of Mule Runtime and Anypoint Studio. To find out more about these applications, consult the xref:3.9@mule-runtime::index.adoc[Mule User Guide] and xref:6@studio::index.adoc[Anypoint Studio documentation].
