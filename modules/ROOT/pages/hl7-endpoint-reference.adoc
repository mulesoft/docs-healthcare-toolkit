...
image::hl7-endpoint-general.png[hl7_Endpoint_general]
...
image::hl7-endpoint-advanced.png[hl7_endpoint_advanced]
...
|*(Boolean)* Enables https://docs.mulesoft.com/mule-user-guide/v/3.8/business-events[Business Events] for the Endpoint.
|
----
...
image::hl7-endpoint-references.png[hl7_endpoint_references]
...
|XML
|*Connector Reference*
|References an HL7 connector configured as a https://docs.mulesoft.com/mule-user-guide/v/3.8/global-elements[Global Element].
|
----
...
----
|*Connector Reference*
|Allows you to reference an HL7 connector configured as a https://docs.mulesoft.com/mule-user-guide/v/3.8/global-elements[Global Element].
|
----
connector-ref="HL7connectorName"
----
