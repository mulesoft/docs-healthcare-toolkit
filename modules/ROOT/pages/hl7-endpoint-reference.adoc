...
image::hl7-endpoint-general.png[]
...
image::hl7-endpoint-advanced.png[]
...
|*(Boolean)* Enables xref:3.8@mule-runtime::business-events.adoc[Business Events] for the Endpoint.
|
----
...
image::hl7-endpoint-references.png[]
...
|XML
|*Connector Reference*
|References an HL7 connector configured as a xref:3.8@mule-runtime::global-elements.adoc[Global Element].
|
----
...
----
|*Enable default events tracking*
|*(Boolean)* Enables xref:3.7@mule-runtime::business-events.adoc[Business Events] for the Endpoint.
|
----
tracking:enable-default-events="true"
----
...
----
|*Connector Reference*
|Allows you to reference an HL7 connector configured as a xref:3.8@mule-runtime::global-elements.adoc[Global Element].
|
----
connector-ref="HL7connectorName"
----
