...
The HL7 exception strategy sets the flow's https://docs.mulesoft.com/mule-user-guide/v/3.8/error-handling[exception strategy] to HL7, instead of the https://docs.mulesoft.com/mule-user-guide/v/3.8/error-handling[default]. Additionally, it generates and sends an ACK message with the appropriate error code to the originating application.
