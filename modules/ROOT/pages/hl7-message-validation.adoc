...
* A xref:3.8@mule-runtime::variable-transformer-reference.adoc[Variable Transformer] defines variables for logging.
* A xref:3.8@mule-runtime::logger-component-reference.adoc[Logger Component] performs logging.
* A xref:3.8@mule-runtime::flow-reference-component-reference.adoc[Flow Ref Component] invokes the next flow.
