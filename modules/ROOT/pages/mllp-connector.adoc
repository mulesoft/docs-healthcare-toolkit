...
xref:6.x@studio::index.adoc[Anypoint Studio]. To increase your familiarity with Studio, consider completing the
xref:6.x@studio::basic-studio-tutorial.adoc[Basic Studio Tutorial]. This page requires some basic knowledge of
