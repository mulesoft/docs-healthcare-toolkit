...
You can only configure schema locations in Studio's XML view.
...
Use HL7 EDI connector in your flows for reading and writing messages, and sending acknowledgments.
